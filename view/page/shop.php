...
<?php
    ...
    $pro_cate = "SELECT * FROM sanpham, loaisp, thuonghieu
        ...
        AND sanpham.maloaisp='$_GET[id]'";
    $conn_pro = mysqli_query($conn, $pro_cate);

    $name_cate = "SELECT * FROM loaisp WHERE loaisp.maloai='$_GET[id]' LIMIT 1";
    $conn_name_cate = mysqli_query($conn, $name_cate);
    $row_name = mysqli_fetch_array($conn_name_cate)
?>
        ...
        <div class="container">
            ...
            <?php include "view/menu_pro.php"; ?>
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    <h2>NAME CATE: <b><?php  echo $row_name['tenloai']; ?></b></h2>
