...
<?php
    ...
    $pro_cate = "SELECT * FROM sanpham, loaisp, thuonghieu
        ...
        AND sanpham.mathuonghieu='$_GET[id]'";
    $conn_pro = mysqli_query($conn, $pro_cate);

    $name_brand = "SELECT * FROM thuonghieu WHERE thuonghieu.mathuonghieu='$_GET[id]' LIMIT 1";
    $conn_name_brand = mysqli_query($conn, $name_brand);
    $row_name = mysqli_fetch_array($conn_name_brand)
        ...
        <div class="container">
            ...
            <?php include "view/menu_pro.php"; ?>
                <div class="col-lg-9 order-1 order-lg-2">
                    <h2>NAME BRAND: <b><?php  echo $row_name['tenthuonghieu']; ?></b></h2>
