<?php
	...
	$sql_get_vanchuyen = mysqli_query($conn,"SELECT * FROM tbl_shipping WHERE matk='$id_khachhang' LIMIT 1");
	...
	//insert vào đơn hàng
		$insert_cart = "INSERT INTO tbl_cart(matk,code_cart,cart_status,cart_date,cart_payment,cart_shipping) VALUE('".$id_khachhang."','".$code_order."',1,'".$now."','".$cart_payment."','".$id_shipping."')";
		...
		header('Location:../../index.php?click=camon');
		...
		*/
		...
		$vnp_TmnCode = "CRV4RSD9"; //Website ID in VNPAY System
		$vnp_HashSecret = "MIVXOCZMMGJCYMXZBJWZZAAYGUINHNIG"; //Secret key
		$vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";

		$vnp_Returnurl = "http://shop2hand.net/index.php?click=camon";
