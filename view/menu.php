			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full ">
					...
					<div style="margin-right:30px;" class="right-top-bar flex-w h-full">
							...
							?>
							<a href="#" class="flex-c-m trans-04 p-lr-25">
								Wellcome <?php echo $_SESSION['dangky'];?>
							</a>
				...
				<nav class="limiter-menu-desktop ">
                    ...
                    <div class="col-lg-6 text-center col-md-7">
                        <div class="menu-desktop">
                            <ul class="main-menu">
								<li class="">
                                    <a href="index.php?click=trangchu">HOME</a>
                                </li>
                    ...
                    <div class="col-lg-4 text-right col-md-3">
                        <div class="wrap-icon-header flex-w flex-r-m">
							...
							?>
									...
									<div class="dropdown">
									<a href="index.php?click=profile&matk=<?php echo $_SESSION['id_khachhang']; ?>" data-toggle="tooltip" title="My account!"><img style="width:45px;" src="img/user.png" alt=""></a>
									<?php echo $_SESSION['dangky'];?>
  									<div class="dropdown-content">
									
									<ul><li><a href="index.php?click=profile&matk=<?php echo $_SESSION['id_khachhang']; ?>">Tài khoản của tôi</a></li></ul>
									<ul><li><a href="index.php?click=lichsugiaodich&matk=<?php echo $_SESSION['id_khachhang']; ?>">Đã mua</a></li></ul>
									<ul><li><a href="view/page/logout.php?out=1">Đăng xuất</a></li></ul>
							...
							?>
								<a href="#" data-toggle="tooltip" title="My account!"><img style="width:45px;" src="" alt=""></a>
            ...
            ?>
				<ul class="header-cart-wrapitem w-full">
					...
					<span style="font-size: 30px;" class="dec qtybtn"><a style="color: black;" href="view/page/xulygiohang.php?xoa_modal=<?php  echo $cart_item['masp']; ?> ">X</a></span>
						<div class="">
							<img src="upload/<?php echo $cart_item['anh']; ?>" alt="IMG" width="50px">
						</div>
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						...
						<a href="index.php?click=cart" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
